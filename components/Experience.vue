<template>
  <div>
    <h1 class="font-title font-bold relative text-2xl md:text-3xl mt-12">
      Experience<span class="iconblog w-6 h-6 md:w-8 md:h-8 top-22 ml-3"></span>
    </h1>
    <div class="list mt-8">
      <ul>
        <li class="xl:flex xl:flex-row">
          <div class="list flex justify-between xl:self-start xl:flex-col mb-4">
          ...
          <div class="flex xl:w-192 xl:ml-10 justify-start">
            <img
              ...
              alt="logo Concept Factory"
            />
            <p class="xl:min-w-maxcontent font-dosis ml-5 xl:ml-10 sm:text-xl">
              Développeur front-end (stage)<br />
              <span class="font-bold text-blue-600">Concept Factory</span>
            </p>
          </div>
          <p class="font-dosis sm:text-xl mt-4 xl:mt-0 xl:pl-36">
